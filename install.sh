apt update && apt install -y openssh-server systemctl wget curl vim nano screen
...
wget -O /root/sing-box-warp/systemctl.sh https://github.sock.cf/ahhfzwl/sing-box/blob/dev-next/systemctl.sh
